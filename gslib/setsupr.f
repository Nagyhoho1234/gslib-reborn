...
c   - Pre-compute reciprocals for super block size calculations
c   - Minimize redundant multiplications in data loop
...
c
c Pre-compute total number of super blocks and nxsup*nysup product:
c
      nxysp = nxsup*nysup
      nsblk = nxysp*nzsup
c
