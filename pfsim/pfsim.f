...
c
      parameter(MAXSIZ =10000000, MAXCUT = 11, MAXDAT =5000000)
c
c Fixed parameters:
c
      parameter(EPSLON=1.0e-20,VERSION=2026.1)
c
...
c
      write(*,9999) VERSION
 9999 format(/' PFSIM - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
...
c
c Loop over all of the realizations and locations (buffered I/O):
c
      do isim=1,nsim
      index = 0
      do iz=1,nz
...
c
      write(*,9998) VERSION
 9998 format(/' PFSIM - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
