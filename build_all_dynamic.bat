...
REM  Dynamic OpenMP linking - small exes, needs libiomp5md.dll
REM  Output: bin_opt2/ (~33 MB + 1.6 MB DLL)
REM ============================================================
...
set FFLAGS_LIB=/c /O2 /Qopenmp /heap-arrays0
set BINDIR=%ROOT%\bin_opt2
