...
echo === Building bicalib ===
cd /d c:\Codename_EpicFury\gslib2_opt\bicalib
%FC% %FFLAGS% bicalib.f %GSLIB% /Fe:%BIN%\bicalib.exe
if errorlevel 1 (echo BICALIB FAILED) else (echo BICALIB OK)
