...
c
c-----------------------------------------------------------------------
      parameter(MAXNST=10, MDIR=25, DEG2RAD=3.14159265/180.0,
     +          MAXROT=MAXNST+1, EPSLON = 1.0e-20, VERSION=2026.1)
...
c
      write(*,9999) VERSION
 9999 format(/' VMODEL - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
...
c
      close(lout)
      write(*,9998) VERSION
 9998 format(/' VMODEL - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
