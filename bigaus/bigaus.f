...
c
c OPTIMIZED VERSION:
c   - No major I/O or array bottlenecks identified
c   - Program is computation-bound (numerical integration)
c   - MLAG increased from 50 to 200 for larger lag counts
c   - MDIR increased from 4 to 12 for more directions
c
...
c-----------------------------------------------------------------------
     ...
     +            MLAG=200, MDIR=12, MAXNST=4, MAXROT=4, VERSION=2026.1)
...
c
      write(*,9999) VERSION
 9999 format(/' BIGAUS - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
...
c
      close(lout)
      write(*,9998) VERSION
 9998 format(/' BIGAUS - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
