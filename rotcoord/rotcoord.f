...
c
c-----------------------------------------------------------------------
      parameter(DEG2RAD=3.14159265/180.0,EPSLON=1.0e-6,
     +          MAXLEN=132,VERSION=2026.1)
c
c Dimensioning:
c
      real      var(50)
...
c
      write(*,9999) VERSION
 9999 format(/' ROTCOORD - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
...
c
      ...
      read (*,'(a40)') str(1:40)
      if(str(1:1).eq.' ')str='rotcoord.par                            '
...
c
      ...
      close(lout)
      write(*,9998) VERSION
 9998 format(/' ROTCOORD - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
