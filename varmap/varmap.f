...
c
      write(*,9998) VERSION
 9998 format(/' VARMAP - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
      end
...
c
      write(*,9999) VERSION
 9999 format(/' VARMAP - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
