...
c
      write(*,9998) VERSION
 9998 format(/' NEWCOKB3D - GSLIB2-OPT v',f7.1, ' Finished'/)
      stop
      end
...
c
      write(*,9999) VERSION
 9999 format(/' NEWCOKB3D - GSLIB2-OPT v',f7.1,' (64-bit, OpenMP)'/
...
c OPTIMIZED: Allocate output buffer for batch I/O writes.
c
      nxyz_tot = nx*ny*nz
